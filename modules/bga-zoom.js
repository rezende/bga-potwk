  ...
  return function () {
    ...
    if (options.leading) {
      ...
      func.call.apply(
        // if leading
        func,
        __spreadArray([this], args, false)
      ); //call the 1st instance
    } else {
      // else it's trailing
      lastRan = this; //update context
      trailingArgs = args; //save for later
    ...
    var coolDownPeriodComplete = function () {
      if (options.trailing && trailingArgs) {
        ...
        func.call.apply(
          // if trailing and the trailing args exist
          func,
          __spreadArray([lastRan], trailingArgs, false)
        ); //invoke the instance with stored context "lastRan"
...
var ZoomManager = /** @class */ (function () {
  ...
  function ZoomManager(settings) {
    ...
    if (!settings.element) {
      throw new DOMException(
        "You need to set the element to wrap in the zoom element"
      );
    }
    this._zoomLevels =
      (_a = settings.zoomLevels) !== null && _a !== void 0
        ? _a
        : DEFAULT_ZOOM_LEVELS;
    ...
    if ((_b = settings.smooth) !== null && _b !== void 0 ? _b : true) {
      ...
      settings.element.addEventListener(
        "transitionend",
        advThrottle(
          function () {
    ...
    if (
      (_d =
        (_c = settings.zoomControls) === null || _c === void 0
          ? void 0
          : _c.visible) !== null && _d !== void 0
        ? _d
        : true
    ) {
    ...
    this.throttleTime =
      (_e = settings.throttleTime) !== null && _e !== void 0 ? _e : 100;
    window.addEventListener(
      ...
      advThrottle(
        function () {
          ...
          if (
            (_a = _this.settings.autoZoom) === null || _a === void 0
              ? void 0
              : _a.expectedWidth
          ) {
            _this.setAutoZoom();
    ...
    if (
      (_f = this.settings.autoZoom) === null || _f === void 0
        ? void 0
        : _f.expectedWidth
    ) {
      this.setAutoZoom();
  ...
  ZoomManager.prototype.setAutoZoom = function () {
    var _this = this;
    var _a, _b, _c;
    var zoomWrapperWidth =
      document.getElementById("bga-zoom-wrapper").clientWidth;
    if (!zoomWrapperWidth) {
      setTimeout(function () {
    ...
    var expectedWidth =
      (_a = this.settings.autoZoom) === null || _a === void 0
        ? void 0
        : _a.expectedWidth;
    var newZoom = this.zoom;
    while (
      newZoom > this._zoomLevels[0] &&
      newZoom >
        ((_c =
          (_b = this.settings.autoZoom) === null || _b === void 0
            ? void 0
            : _b.minZoomLevel) !== null && _c !== void 0
          ? _c
          : 0) &&
    ...
    if (this._zoom == newZoom) {
      if (this.settings.localStorageZoomKey) {
        localStorage.setItem(
          this.settings.localStorageZoomKey,
          "" + this._zoom
        );
      }
    } else {
  ...
  ZoomManager.prototype.setZoomLevels = function (zoomLevels, newZoom) {
    ...
    var zoomIndex =
      newZoom && zoomLevels.includes(newZoom)
        ? this._zoomLevels.indexOf(newZoom)
        : this._zoomLevels.length - 1;
  ...
  ZoomManager.prototype.setZoom = function (zoom) {
    ...
    (_b = this.zoomOutButton) === null || _b === void 0
      ? void 0
      : _b.classList.toggle("disabled", newIndex === 0);
    this.settings.element.style.transform =
      zoom === 1 ? "" : "scale(".concat(zoom, ")");
    (_d = (_c = this.settings).onZoomChange) === null || _d === void 0
      ? void 0
      : _d.call(_c, this._zoom);
  ...
  ZoomManager.prototype.zoomOrDimensionChanged = function () {
    var _a, _b;
    this.settings.element.style.width = "".concat(
      this.wrapper.offsetWidth / this._zoom,
      "px"
    );
    this.wrapper.style.height = "".concat(
      this.settings.element.offsetHeight * this._zoom,
      "px"
    );
    (_b = (_a = this.settings).onDimensionsChange) === null || _b === void 0
      ? void 0
      : _b.call(_a, this._zoom);
  };
  /**
  ...
  ZoomManager.prototype.initZoomControls = function (settings) {
    ...
    this.zoomControls.dataset.position =
      (_b =
        (_a = settings.zoomControls) === null || _a === void 0
          ? void 0
    ...
    if (
      (_d = settings.zoomControls) === null || _d === void 0
        ? void 0
        : _d.customZoomInElement
    ) {
    ...
    this.setZoomControlsColor(
      (_f =
        (_e = settings.zoomControls) === null || _e === void 0
          ? void 0
