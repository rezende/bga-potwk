...
'game_name' => "Paladins of The West Kingdom",

// Game publisher (use empty string if there is no publisher)
'publisher' => 'Garphill Games',

// Url of game publisher website
'publisher_website' => 'https://garphill.com/',

// Board Game Geek ID of the publisher
'publisher_bgg_id' => 9459,
...
'tie_breaker_description' => clienttranslate("Smallest amount of suspicion"),
...
// Favourite colors support : if set to "true", support attribution of favourite colors based on player's preferences (see reattributeColorsBasedOnPreferences PHP method)
// NB: this parameter is used only to flag games supporting this feature; you must use (or not use) reattributeColorsBasedOnPreferences PHP method to actually enable or disable the feature.
'favourite_colors_support' => true,
