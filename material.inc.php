...
$this->tavern_cards_material = [
    // Approved mapping 2026-08-29 (card N = index N-1)
    // Codes: r=fighter b=merchant w=labourer p=criminal bl=cleric g=scout
    [WORKER_BLACK, WORKER_GREEN, WORKER_WHITE, WORKER_WHITE],           // 1
    [WORKER_RED, WORKER_RED, WORKER_GREEN, WORKER_PURPLE],              // 2
    [WORKER_BLUE, WORKER_BLUE, WORKER_GREEN, WORKER_PURPLE],            // 3
    [WORKER_RED, WORKER_RED, WORKER_PURPLE, WORKER_WHITE],              // 4
    [WORKER_BLACK, WORKER_GREEN, WORKER_GREEN, WORKER_PURPLE],          // 5
    [WORKER_RED, WORKER_BLUE, WORKER_GREEN, WORKER_PURPLE],             // 6
    [WORKER_BLUE, WORKER_BLUE, WORKER_WHITE, WORKER_WHITE],             // 7
    [WORKER_BLUE, WORKER_BLUE, WORKER_GREEN, WORKER_GREEN],             // 8
    [WORKER_BLACK, WORKER_BLACK, WORKER_RED, WORKER_GREEN],             // 9
    [WORKER_BLACK, WORKER_BLACK, WORKER_BLUE, WORKER_GREEN],           // 10
    [WORKER_RED, WORKER_RED, WORKER_BLUE, WORKER_PURPLE],               // 11
    [WORKER_RED, WORKER_GREEN, WORKER_PURPLE, WORKER_PURPLE],           // 12
    [WORKER_BLUE, WORKER_BLUE, WORKER_GREEN, WORKER_WHITE],             // 13
    [WORKER_BLACK, WORKER_BLACK, WORKER_BLUE, WORKER_WHITE],            // 14
    [WORKER_RED, WORKER_BLUE, WORKER_GREEN, WORKER_GREEN],              // 15
    [WORKER_RED, WORKER_PURPLE, WORKER_PURPLE, WORKER_WHITE],             // 16
    [WORKER_BLACK, WORKER_WHITE, WORKER_PURPLE, WORKER_WHITE],           // 17
    [WORKER_BLACK, WORKER_BLACK, WORKER_BLUE, WORKER_BLUE],             // 18
    [WORKER_RED, WORKER_RED, WORKER_WHITE, WORKER_WHITE],                // 19 (user: r,rw,w → assumed r,r,w,w)
    [WORKER_BLACK, WORKER_BLACK, WORKER_BLACK, WORKER_RED],             // 20
    [WORKER_BLACK, WORKER_BLACK, WORKER_RED, WORKER_BLUE],             // 21
    [WORKER_GREEN, WORKER_GREEN, WORKER_GREEN, WORKER_WHITE],           // 22
    [WORKER_RED, WORKER_BLUE, WORKER_PURPLE, WORKER_PURPLE],            // 23
    [WORKER_RED, WORKER_PURPLE, WORKER_WHITE, WORKER_WHITE],             // 24
];
